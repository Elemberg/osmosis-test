...
type QuerySwapExactAmountInRequest struct {
	...
	Routes  []poolmanagertypes.SwapAmountInRoute `protobuf:"bytes,4,rep,name=routes,proto3" json:"routes" yaml:"routes"`
}
...
func (m *QuerySwapExactAmountInRequest) GetRoutes() []poolmanagertypes.SwapAmountInRoute {
	if m != nil {
		return m.Routes
	}
	return nil
...
type QuerySwapExactAmountOutRequest struct {
	Sender   string                      `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	PoolId   uint64                      `protobuf:"varint,2,opt,name=pool_id,json=poolId,proto3" json:"pool_id,omitempty" yaml:"pool_id"`
	Routes   []poolmanagertypes.SwapAmountOutRoute `protobuf:"bytes,3,rep,name=routes,proto3" json:"routes" yaml:"routes"`
...
func (m *QuerySwapExactAmountOutRequest) GetRoutes() []poolmanagertypes.SwapAmountOutRoute {
	if m != nil {
		return m.Routes
	}
	return nil
...
func (m *QuerySwapExactAmountInRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Routes = append(m.Routes, poolmanagertypes.SwapAmountInRoute{})
...
func (m *QuerySwapExactAmountOutRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Routes = append(m.Routes, poolmanagertypes.SwapAmountOutRoute{})
			if err := m.Routes[len(m.Routes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
