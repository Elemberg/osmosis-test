...
type MsgSwapExactAmountIn struct {
	Sender            string                                 `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	Routes            []poolmanagertypes.SwapAmountInRoute             `protobuf:"bytes,2,rep,name=routes,proto3" json:"routes"`
...
func (m *MsgSwapExactAmountIn) GetRoutes() []poolmanagertypes.SwapAmountInRoute {
	if m != nil {
		return m.Routes
	}
	return nil
...
type MsgSwapExactAmountOut struct {
	Sender           string                                 `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	Routes           []poolmanagertypes.SwapAmountOutRoute            `protobuf:"bytes,2,rep,name=routes,proto3" json:"routes"`
...
func (m *MsgSwapExactAmountOut) GetRoutes() []poolmanagertypes.SwapAmountOutRoute {
	if m != nil {
		return m.Routes
	}
	return nil
